...
def get_combined_style_rules(style_rule_list):
    ...
    for style_key in style_dict:
        style_str = style_key + "{" + "; ".join(style_dict[style_key]) + ";}"
...
for file_name in file_list:
    ...
    with open(file_name.split(".")[0] + ".adguard.txt", "w") as output_file:
        for line in get_meta(input_list):
            print(line, file=output_file)
        if "mobile" in file_name:
            print("!#if (adguard && !adguard_ext_chromium)", file=output_file)
